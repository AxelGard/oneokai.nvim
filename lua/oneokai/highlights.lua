...
hl.common = {
    ...
    DiffRemoved = colors.Orange,
    DiffFile = colors.Cyan,
    DiffIndexLine = colors.Grey,
    Directory = {fg = c.green},
    ErrorMsg = {fg = c.orange, fmt = "bold"},
...
hl.syntax = {
    ...
    Identifier = {fg = c.orange, fmt = cfg.code_style.variables},
...
if vim.api.nvim_call_function("has", { "nvim-0.8" }) == 1 then
    hl.treesitter = {
        ...
        ["@punctuation.special"] = colors.Orange,
        ["@repeat"] = {fg = c.orange, fmt = cfg.code_style.keywords},
        ["@string"] = {fg = c.yellow, fmt = cfg.code_style.strings},
        ["@string.regex"] = {fg = c.purple, fmt = cfg.code_style.strings},
        ["@string.escape"] = {fg = c.orange, fmt = cfg.code_style.strings},
        ["@symbol"] = colors.Cyan,
        ["@tag"] = colors.Orange,
    ...
    hl.treesitter = {
        ...
        TSKeywordFunction = {fg = c.orange, fmt = cfg.code_style.functions},
...
hl.langs.c = {
    ...
    cStorageClass = colors.Orange,
    cTypedef = colors.Orange,
    cDefine = colors.Cyan,
    cTSInclude = colors.Green,
    cTSConstant = colors.Cyan,
    cTSConstMacro = colors.Orange,
    cTSOperator = colors.Orange,
}
...
hl.langs.cpp = {
    ...
    cppTSConstMacro = colors.Orange,
    cppTSOperator = colors.Orange,
}
